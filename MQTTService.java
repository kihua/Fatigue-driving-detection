...
public class MQTTService extends Service {
    ...
    private String host = "tcp://avuqmrg.iot.gz.baidubce.com:1883";
    private String userName = "avuqmrg/android_mqtt";
    private String passWord = "zHMCNQyStZsRGOiQ";
    private static String myTopic = "LED_WXW";      //要订阅的主题
    private String clientId = "androidId1";//客户端标识
